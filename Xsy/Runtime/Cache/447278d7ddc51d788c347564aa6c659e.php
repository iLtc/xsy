...
<![endif]-->
<form action="__APP__?m=Baoming&a=step2" id="bm" class="form-horizontal">
<div class="control-group" id="id">
	<label for="id" class="control-label">红满堂ID</label>
    <div class="controls">
    	<input name="id" id="id" value="<?php echo ($name); ?>" type="text" readonly="readonly"/>
    </div>
</div>
...
<div class="control-group" id="college">
    ...
    <div class="controls">
        <select name="college" tabindex="7" onChange="checkcol(0,2)" class="college" id="college">
        ...
        <span class="help-inline" id="college">(新生及在校生必选，13级<a href="http://zsb.scau.edu.cn/wenzi/2013pglqcx.htm" target="new">查询</a>)</span>
    </div>
</div>
<div class="control-group" id="zhuanye">
	<label for="zhuanye" class="control-label">录取专业</label>
    <div class="controls" id="zhuanye2">
    	<select name="zhuanye" id="zhuanye" tabindex="8" onchange="checkzy(2)">
            <option value="error">请选择</option>
        </select>
        <span class="help-inline" id="zhuanye">(新生及在校生必选，13级<a href="http://zsb.scau.edu.cn/wenzi/2013pglqcx.htm" target="new">查询</a>)</span>
    </div>
</div>
<div class="control-group" id="diqu">
	<label for="diqu" class="control-label">所在地区</label>
    <div class="controls">
    	<select name="diqu" id="diqu" onChange="checkdq()" tabindex="9">
            <option value="error">请选择</option>
            <option>广州市</option>
            <option>深圳市</option>
            <option>珠海市</option>
          ...
          <input type="text" name="diqu1" id="diqu1" maxlength="10" style="display:none;" onBlur="checkdq1()" tabindex="9">
        <span class="help-inline" id="diqu">(必填)</span>
    </div>
</div>
<div class="control-group" id="shijian">
	<label for="shijian" class="control-label">预计离开时间</label>
    <div class="controls">
    	<select name="shijian" id="shijian" tabindex="10">
            <option value="服从安排" selected="selected">服从安排</option>
...
<div class="control-group" id="dz">
	<label for="dz" class="control-label">从何处得知新生游</label>
	<div class="controls">
    	<select name="dz" id="dz" onchange="checkdz()" tabindex="11">
        ...
        <span class="help-inline" id="dz">(必选)</span>
    </div>
</div>
...
<div class="form-actions">
	<button type="button" class="btn btn-primary" id="submit" onclick="check(1)" tabindex="13">提交</button><span id="info"></span>
</div>
</form>